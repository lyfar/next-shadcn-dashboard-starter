...
import { Clock, AlertCircle, Info, Gift } from 'lucide-react';
        ...
        {rzdsAmount > 0 || claimed ? (
          ...
          <div className="bg-secondary/10 p-4 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              You currently have no RZDS to claim. Keep trading and participating in activities to earn more rewards!
            </p>
            <Button variant="outline" className="w-full mb-4">Explore Ways to Earn</Button>
          </div>
        )}
